...
See [CHANGELOG.md](https://github.com/Zhang-JiahangH/virtualized-diff-viewer/blob/main/benchmark-results/results.md) for tracked releases and supported capabilities.
